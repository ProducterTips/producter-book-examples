...
class DiaryYearCollectionViewController: UICollectionViewController {
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        _ = collectionView.dequeueReusableCell(withReuseIdentifier: "DiaryCollectionViewCell", for: indexPath) as! DiaryCollectionViewCell
        
        let dvc = self.storyboard?.instantiateViewController(withIdentifier: "DiaryMonthDayCollectionViewController") as! DiaryMonthDayCollectionViewController // 获取 DiaryYearCollectionViewController
        dvc.year = year
