...
class HomeCollectionViewController: UICollectionViewController {
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> HomeYearCollectionViewCell {
        ...
        let components = (Calendar.current as NSCalendar).component(NSCalendar.Unit.year, from: Date())
        var year = components
        if sectionsCount > 0 {
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let dvc = self.storyboard?.instantiateViewController(withIdentifier: "DiaryYearCollectionViewController") as! DiaryYearCollectionViewController
